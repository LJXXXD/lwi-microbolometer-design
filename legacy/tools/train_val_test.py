...
from tools import NoisyDataset, k_fold_train_val, test_epoch
...
def train_val_test(dataset, train_params):
    ...
    for test_noise in train_params.test_noise_list:
        ...
        test_loss, pred_list, targ_list = test_epoch(
            models[best_model_index], train_params.device, test_loader, train_params.criteria
        )
...
def train_val_test_pretrained(dataset, train_params, model):
    ...
    test_loss, pred_list, targ_list = test_epoch(
        model, train_params.device, test_loader, train_params.criteria
    )
