...
#     out = np.trapezoid(abso_spec, sim_params.spectra, axis=0)
...
#     # Integrate over the wavelengths to get sensor outputs
#     out = np.trapezoid(abso_spec, wavelengths.flatten(), axis=0)  # Shape (m,)
#     return out
...
def visualize_sensor_output(
    sensor_outputs, substances_names=None, basis_funcs_labels=None, fontsize=10, figure_size=(8, 6)
):
    """
