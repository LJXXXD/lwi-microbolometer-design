...
def generate_gaussian_basis_functions(
    wavelengths, num_functions, mean_range=(6, 18), sigma_range=(0.5, 3.0), random_seed=None
):
    """
    ...
    for i, (mu, sigma) in enumerate(zip(means, sigmas, strict=False)):
...
def generate_structured_gaussian_basis_functions(
    wavelengths, mean_range=(4, 20), step=1, widths=(0.5, 1.0, 2.0, 4.0)
):
    """
