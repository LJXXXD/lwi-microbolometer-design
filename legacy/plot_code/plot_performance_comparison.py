...
for bar in bars:
    yval = bar.get_height()
    plt.text(
        bar.get_x() + bar.get_width() / 2.0, yval, f"{yval:.2%}", ha="center", va="bottom"
    )  # ha='center' to align the text in the center of the bar
...
plt.grid(True, linestyle="--", which="major", color="grey", alpha=0.25)
