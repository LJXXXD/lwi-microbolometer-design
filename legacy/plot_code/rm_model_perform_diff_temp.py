...
for temp_K_ind, temp_K in enumerate(temp_K_list):
    ...
    for substance_ind_list in sub_combs:
        for num_basis_func_ind, num_basis_func in enumerate(range(1, len(basis_func_ind_list) + 1)):
            ...
            basis_func_combs = [
                tuple([basis_func_ind_list[i] for i in ind]) for ind in basis_func_combs
            ]
                ...
                for train_noise in train_noise_list:
                    for test_noise in test_noise_list:
                        ...
                        history, models, best_model_index, avg_test_loss, pred_list, targ_list = (
                            train_val_test_pretrained(dataset, train_params, model)
                        )
                        ...
                        row["AVG skewnorm 95% interval range"] = perc95_avg
