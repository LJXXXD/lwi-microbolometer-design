...
df["Value in group"] = (
    df.groupby(["Temperature_K", "Substance Number", "Substance Comb", "Basis Function Number"])[
        "L1Loss"
...
b_func_value_sums = df.groupby(
    ["Temperature_K", "Substance Number", "Substance Comb", "Basis Function Number"]
).agg(
    {
        "b_func 0 value": "sum",
        "b_func 1 value": "sum",
