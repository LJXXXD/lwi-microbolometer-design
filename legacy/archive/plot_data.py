...
baseline_file_name = "outputs/legacy_output/estimated_baseline.pkl"
...
min_l1loss_rows = (
    ...
    .apply(lambda x: x[x.L1Loss == x.L1Loss.min()])
    .reset_index(drop=True)
)

# Pivot the table to have the L1 loss values as columns
table = pd.pivot_table(
    min_l1loss_rows, values="L1Loss", index="Basis Function Number", columns="Substance Number"
)
