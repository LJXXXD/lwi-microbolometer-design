...
air_trans, basis_funcs, spectra, substances_emit = load_data(
    air_trans_file="./data/Test 2 - 21 Substances/Air transmittance.xlsx",
                ...
                for test_noise_perc in test_noise_perc_list:
                    ...
                    for i, sub_ind in enumerate(substance_ind_list):
                        ...
                        for confidence_perc in (0.68, 0.95, 0.997):
                            ...
                            row[f"Substance {sub_ind} skewnorm {confidence_perc * 100}% low"] = (
                                lower_quantile
                            )
                            row[f"Substance {sub_ind} skewnorm {confidence_perc * 100}% high"] = (
                                upper_quantile
                            )
                            row[
